...
VALUES
(101, 'Amulya', '9876543210', 'ravi@gmail.com', 'Hyderabad'),
...
DROP TRIGGER IF EXISTS CheckTransactionAmount;
...
DROP TRIGGER IF EXISTS TransactionAudit;
...
DROP TRIGGER IF EXISTS UpdateAccountBalance;
...
DROP TRIGGER IF EXISTS PreventInsufficientWithdrawal;
